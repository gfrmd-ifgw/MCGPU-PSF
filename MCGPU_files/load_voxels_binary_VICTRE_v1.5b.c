...
//   MAIN_THREAD printf("#   Original data provided by Christian Graff (%s):\n", file_name_voxels);
//   MAIN_THREAD printf("#   Materials number correspondence and original byte value (first material==0):\n");
// //!!NOTE!!: insert correct material table here (depends on phantom):
//   MAIN_THREAD printf("#        0=air(0), 1=fat(1), 2=skin(2), 3=glandular(29), 4=nipple(33), 5=ligament(88), 6=muscle(14), 7=duct(125),\n");
//   MAIN_THREAD printf("#        8=artery(150)+vein(225), 9=terminal duct lobular unit(95), 10=compression_paddle_polystyrene(50), 11=lesion(200), 12=microcalc(250)\n\n");
//   MAIN_THREAD fflush(stdout);
...
//!!DeBuG!! HARDCODED Conversion table for breast phantoms (MUST MATCH THE "density_LOT" FUNCTION IN KERNEL!!):
          ...
          switch ((int)(*voxel_mat_dens_ptr)[pix])
          {
            ...
            case 250:
              ...
              break;              
            default:
              MAIN_THREAD printf(">>>ERROR ASSIGNING VOXEL VALUE>>> voxel(%lld) = %d ??\n", pix, (int)(*voxel_mat_dens_ptr)[pix]); fflush(stdout);
          }
*/
